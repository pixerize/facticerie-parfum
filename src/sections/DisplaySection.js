    ...
    useLayoutEffect(() => {
        let t1 = gsap.timeline({
            scrollTrigger: {
                ...
                start: 'top-=500 top',
                //bottom is triger container, and top viewport
                end: 'bottom top',
                //scrub for both directions
                scrub: true,
            }
    ...
    return (
        <Section>
            ...
            <TextBlockRight>
                ...
                <Text>
                    Lore, Ipsium, color sit amet conest adispicnig elit.
                    Neceestitaibu diungiuifdnd ispam.
                </Text>
            </TextBlockRight>
